...
public class settings_pack extends settings_interface {
  ...
  public final static class string_types {
    ...
    public final static settings_pack.string_types natpmp_gateway = new settings_pack.string_types("natpmp_gateway");
    ...
    private static string_types[] swigValues = { user_agent, announce_ip, handshake_client_version, outgoing_interfaces, listen_interfaces, proxy_hostname, proxy_username, proxy_password, i2p_hostname, peer_fingerprint, dht_bootstrap_nodes, natpmp_gateway, webtorrent_stun_server, max_string_setting_internal };
    private static int swigNext = 0;
    private final int swigValue;
    private final String swigName;
  }
  ...
  public final static class bool_types {
    ...
    public final static settings_pack.bool_types allow_multiple_connections_per_pid = new settings_pack.bool_types("allow_multiple_connections_per_pid");
    public final static settings_pack.bool_types apply_filter_to_dht = new settings_pack.bool_types("apply_filter_to_dht");
  ...
  public final static class int_types {
    ...
    public final static settings_pack.int_types natpmp_lease_duration = new settings_pack.int_types("natpmp_lease_duration");
    ...
    public final static settings_pack.int_types max_webtorrent_offers = new settings_pack.int_types("max_webtorrent_offers");
